...
-- import           Debug.Trace
-- import           Expression
-- import           Util.Types          (LocalVariable (getLocalVariable))
-- import           Util.Util
-- import           Variable
...
--             assignNewVar2 (getLocalVariable name)
--             (varTableNew, _) <- get
--             let register = getRegister (getLocalVariable name) varTableNew

--             return (expressionSetReg register expr varTableNew)

--         translate _ (AssignStmt name expr) = do
--             (varTable, _) <- get
--             let register = getRegister (getLocalVariable name) varTable
